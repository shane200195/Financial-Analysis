...
function y_cor_generator(graph_x_labels , data){
	var y = 0;
	var y_cor = [];
	for (i=0; i < graph_x_labels.length; i++){
		if (i%25 == 0){
...
function create_line(y_cor, graph_x_labels, graph_y_label, graph_data){
	x_set_length = graph_x_labels.length
	number_of_lines = x_set_length/25
